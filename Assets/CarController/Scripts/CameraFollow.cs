...
public class CameraFollow : MonoBehaviour
{
	...
	// Speedometer
	[SerializeField] Text totDistance;
	...
	*/
	...
	void FixedUpdate()
	{
		...
		if (totDistance != null && vehicle != null)
		{
			dist = Vector3.Distance(firstPosition, rb.transform.position);
			...
			if (dist > newDist)
			{
				...
				StringBuilder sb = new StringBuilder();
				sb.Append("Distance:");
				sb.Append(((int)(dist)).ToString());
				sb.Append(" m");

				totDistance.text = sb.ToString();
			}
		}
		*/
	}
